...
/* CUSTOM IMAGE SIZES */
add_image_size( 'thumb32', 32, 32, false );
add_image_size( 'thumb50', 50, 50, false );
add_image_size( 'thumb50', 64, 64, false );
add_image_size( 'thumb90', 90, 90, false );
add_image_size( 'thumb120', 120, 120, false );
add_image_size( 'thumb150', 150, 150, false );
add_image_size( 'thumb180', 180, 180, false );
add_image_size( 'w240', 240, 9999, false );
add_image_size( 'event_thumb', 90, 255, true );
add_image_size( 'w320', 320, 9999, false );
add_image_size( 'w480', 480, 9999, false );
add_image_size( 'w640', 640, 9999, false );
add_image_size( 'w748', 748, 9999, false );
add_image_size( 'w768', 768, 9999, false );
add_image_size( 'w960', 960, 9999, false );
add_image_size( 'w1024', 1024, 9999, false );
add_image_size( 'w1280', 1280, 9999, false );
add_image_size( 'w1440', 1440, 9999, false );
add_image_size( 'w1600', 1600, 9999, false );
add_image_size( 'w1920', 1920, 9999, false );
add_image_size( 'h360', 1920, 360, false );
add_image_size( 'h400', 1920, 400, false );
add_image_size( 'h480', 1920, 480, false );
add_image_size( 'h1080', 1920, 1080, false );
